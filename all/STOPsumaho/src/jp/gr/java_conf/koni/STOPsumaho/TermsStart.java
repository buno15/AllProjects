...
public class TermsStart extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button1.setTextSize(14 * Main.setScaleSize(getApplicationContext()));
		...
		button2.setTextSize(14 * Main.setScaleSize(getApplicationContext()));
	...
	public void savekiyakucount() {
		SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
		sp.edit().putBoolean("Savekiyakucount", Main.termstf).commit();
	}
}
