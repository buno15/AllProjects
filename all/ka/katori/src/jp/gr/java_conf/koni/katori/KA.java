...
public class KA {
	...
	public KA(int id) {// id0=レベル1、id5=レベル6
		...
		bunooboi = new BUNOOBOI(this, Play.kaCount, rnd.nextInt(100) + 100, rnd.nextInt(100) + 100, rnd.nextInt(100) + 100, rnd.nextInt(100) + 100,
				rnd.nextInt(10) + 10, rnd.nextInt(10) + 20, rnd.nextInt(30) + 50, rnd.nextInt(10) + 20, 1);
	}
