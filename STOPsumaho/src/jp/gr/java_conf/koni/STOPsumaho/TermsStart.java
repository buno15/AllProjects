...
public class TermsStart extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setRequestedOrientation((ActivityInfo.SCREEN_ORIENTATION_PORTRAIT));
		setContentView(R.layout.termsstart);
		setTitle("利用規約");

		TextView textview = (TextView) findViewById(R.id.textview);
		textview.setTextSize(8 * Main.setScaleSize(getApplicationContext()));
		textview.setText("利用規約\n" + "\n" + "\n"
		...
		Button button1 = (Button) findViewById(R.id.button1);// 同意する
		button1.setTextSize(12 * Main.setScaleSize(getApplicationContext()));
		button1.setText("同意する");
		button1.setTextColor(Color.WHITE);
		button1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Values.termstf = false;
				IO.termstf(true);
		...
		Button button2 = (Button) findViewById(R.id.button2);// 同意しない
		button2.setTextSize(12 * Main.setScaleSize(getApplicationContext()));
		button2.setText("同意しない");
