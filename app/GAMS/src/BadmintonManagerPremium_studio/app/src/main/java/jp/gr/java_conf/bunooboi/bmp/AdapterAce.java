    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                tv.setBackgroundColor(AceMissObject.getColor(AceMissObject.ACE_GOOD));
                break;
            case 2:
                tv.setBackgroundColor(AceMissObject.getColor(AceMissObject.ACE_NORMAL));
                break;
            case 3:
                tv.setBackgroundColor(AceMissObject.getColor(AceMissObject.ACE_LUCKY));
                break;
        }
        return convertView;
    }
