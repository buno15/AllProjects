...
public class AdapterColor extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (position) {
            case 0:
                image.setBackgroundColor(TeamObject.getColor(TeamObject.BLACK));
                break;
            case 1:
                image.setBackgroundColor(TeamObject.getColor(TeamObject.WHITE));
                break;
            case 2:
                image.setBackgroundColor(TeamObject.getColor(TeamObject.BLUE));
                break;
            case 3:
                image.setBackgroundColor(TeamObject.getColor(TeamObject.GREEN));
                break;
            case 4:
                image.setBackgroundColor(TeamObject.getColor(TeamObject.ORANGE));
                break;
            case 5:
                image.setBackgroundColor(TeamObject.getColor(TeamObject.PINK));
                break;
            case 6:
                image.setBackgroundColor(TeamObject.getColor(TeamObject.PURPLE));
                break;
