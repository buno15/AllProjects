...
public class Larry extends Activity {
    ...
    jp.gr.java_conf.bunooboi.bmf.Meaning meaning;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meaning = new jp.gr.java_conf.bunooboi.bmf.Meaning(this);
        ...
        if (jp.gr.java_conf.bunooboi.bmf.Calculation.MaxPeople == 4) {
            ...
            graph1[2].setGraphColor(jp.gr.java_conf.bunooboi.bmf.TeamObject.getGraphColor(Calculation.TeamColor[0]));
            graph2[2].setGraphColor(jp.gr.java_conf.bunooboi.bmf.TeamObject.getGraphColor(Calculation.TeamColor[1]));
        } else {
            graph1 = new Graph[2];
            graph2 = new Graph[2];
        ...
        graph1[0].setGraphColor(jp.gr.java_conf.bunooboi.bmf.TeamObject.getGraphColor(Calculation.TeamColor[0]));
        graph2[0].setGraphColor(jp.gr.java_conf.bunooboi.bmf.TeamObject.getGraphColor(Calculation.TeamColor[1]));
        graph1[1].setGraphColor(jp.gr.java_conf.bunooboi.bmf.TeamObject.getGraphColor(Calculation.TeamColor[0]));
        graph2[1].setGraphColor(jp.gr.java_conf.bunooboi.bmf.TeamObject.getGraphColor(Calculation.TeamColor[1]));
        ...
        GameButton[0].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                jp.gr.java_conf.bunooboi.bmf.Calculation.ReadEvent(Calculation.Event.get(0), graph1, graph2);
            }
        });
        GameButton[1].setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                jp.gr.java_conf.bunooboi.bmf.Calculation.ReadEvent(Calculation.Event.get(1), graph1, graph2);
            }
        });
        GameButton[2].setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                jp.gr.java_conf.bunooboi.bmf.Calculation.ReadEvent(Calculation.Event.get(2), graph1, graph2);
            }
        });
        ...
        UnderButton[0].setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), jp.gr.java_conf.bunooboi.bmf.Overview.class);
                startActivity(i);
                finish();
            }
        });
